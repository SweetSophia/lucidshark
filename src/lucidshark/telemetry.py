...
_POSTHOG_API_KEY = os.environ.get(
    "LUCIDSHARK_POSTHOG_API_KEY", "phc_jQ0TDwA4tX7DkP5Rf1Pmr6mu9mPgtNmYh2QYkFjNmWP"
)
_POSTHOG_HOST = os.environ.get("LUCIDSHARK_POSTHOG_HOST", "https://us.i.posthog.com")

# Validate POSTHOG_HOST: must use https to prevent plaintext telemetry leakage
if _POSTHOG_HOST and not _POSTHOG_HOST.startswith("https://"):
    LOGGER.warning(
        "LUCIDSHARK_POSTHOG_HOST must use https://. Ignoring override."
    )
